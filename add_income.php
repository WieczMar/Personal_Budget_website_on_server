<?php
    ...
    try 
	{
        ...
        if ($connection->connect_errno!=0)
        {
            ...
            $result = $connection->query("SELECT id, name FROM incomes_category_assigned_to_users WHERE user_id='".$_SESSION['userId']."'");
            if (!$result) throw new Exception($connection->error);
            
            $categoriesCount = $result->num_rows;
            if($categoriesCount>0)
            {
                $rowsIncomeCategory = $result->fetch_all(MYSQLI_ASSOC); 
                $result->free_result(); 
    ...
    <div class="container">
        <div class="row justify-content-center align-items-center">
            <div class="col-10 col-md-8 col-lg-6 col-xl-5 panel">
                ...
                ?>
                <div class="text-center panel-title">Add income</div>
                <form action="save_transaction.php" method="post">
                    ...
                    <div class="form-group input-data">
                        ...
                        <select class="form-select" name="category" aria-label="category">
                            <?php
                                foreach($rowsIncomeCategory as $incomeCategory){
                    ...
                    <div class="form-group input-data">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="comment" id="comment" placeholder="optional"
                                aria-describedby="basic-addon3">
                        </div>
                    </div>
                    <div class="d-grid gap-2 d-sm-flex justify-content-sm-around">
                        <button type="submit" class="btn btn-primary col-sm-3 button" name="addButton" value="income">Add</button>
