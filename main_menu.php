  ...
  <div class="container">
    <div class="row justify-content-center align-items-center">
      <div class="col-sm-10 col-md-6">
        <?php echo "<div class='text-center panel-title'>Welcome ".$_SESSION['username']."!</div>"
        ?>
        <div class="welcome-text">We are happy to see you again in our Personal Budget web app. 
          Let's manage your daily budget and enhance it to the next level without wasting your time anymore. 
          Add your incomes or expenses and view comprehend analysis of your finances in selected period. 
        </div>
      </div>
      <div class="col-sm-10 col-md-6 ">
        <img class="main-site-picture" src="imgs\main-site.jpg." alt="Main site picture" />
      </div>
    </div>
  </div>
